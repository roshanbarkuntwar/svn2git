<%-- 
    Document   : salarySevaarthBrowse
    Created on : Jul 5, 2021, 10:53:49 AM
    Author     : kapil.gupta
--%>
...
<div class="page-section">
    ...
    <div class="tab-section col-md-12 my-1">
        <ul class="nav nav-pills">
            <li onclick="" class="nav-item mr-5"><a class="nav-link active" data-toggle="pill" href="#browse"><p>Salary Sevaarth Browse</p> </a></li>
        </ul>
    ...
    <div class="tab-content px-4 py-4">
        ...
        <div id="browse" class="tab-pane show in active">
            ...
            <s:form name="salarySevaarthDataForm" id="salarySevaarthDataForm" method="post" action="salarySevaarth?search=true" theme="simple"> 
                    ...
                    <div class="row sec-bottom">
                        ...
                        <div class="col-lg-10 col-xl-11">
                            ...
                            <div class="row form-group">
                                <div class="col-lg-3">
                                    <s:textfield type="text" cssClass="form-control" id="DDO_NO" placeholder="DDO_NO" title="DDO_NO" name="SalSevaarthFilterData.ddoNo"/>
                                </div>

                                <div class="col-lg-3">
                                    <s:textfield type="text" cssClass="form-control" id="BILL_ID" placeholder="BILL_ID" title="BILL_ID" name="SalSevaarthFilterData.billId"/>
                                </div>
                                <div class="col-lg-3">
                                    <s:textfield type="text" cssClass="form-control" id="SEVARTH_ID" placeholder="SEVARTH_ID" title="SEVARTH_ID" name="SalSevaarthFilterData.SevarthId"/>
                                </div>

                                <div class="col-lg-3">
                                    <s:textfield type="text" cssClass="form-control" id="DEDUCTEE_PANNO" placeholder="DEDUCTEE_PANNO" title="DEDUCTEE_PANNO" name="SalSevaarthFilterData.DeducteePanno"/>
                                </div>
                        ...
                        <div class="col-lg-2 col-xl-1 pl-0 d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary addon-btn filter-inner-btn" onclick="lhsResetform('salarySevaarthDataForm', 'submit');"  title="Clear & Reset"><i class="fa clear"></i></button>
                ...
                <input type="hidden" id="fltrformId" value="salarySevaarthDataForm">
            </s:form>
