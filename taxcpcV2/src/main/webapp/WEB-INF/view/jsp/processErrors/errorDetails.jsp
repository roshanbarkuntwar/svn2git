            ...
            <div class="tab-content px-4 py-4">
                <div class="container-fluid pt-2">
                    <div id="ErrorDetails" class="tab-pane show in active">
                        ...
                        <s:form name="errorDetails" id="errorDetailsForm" method="POST" action="deducteeErrorDetails?action=showErrorDetails&search=true" theme="simple">
                            <s:hidden name="l_error_type_code"/>
                            <s:hidden name="l_error_type_name"/>
                            <s:hidden name="l_error_name"/>
                            <s:hidden name="l_error_code"/>
                            ...
                            <s:hidden name="ReadonlyFlag" value="%{ReadonlyFlag}"/>

                            <div class="button-section my-1"> 
                                <button type="button" class="form-btn" id="g_download" title="Select filter for download" onclick="downloadStaticExcel('ERROR DETAILS');"><i class="fa download" aria-hidden="true"></i>Capture Page Data in Excel</button>                                
                            </div>
                                ...
                                <div class="row sec-bottom">
                                    <div class="col-lg-10 col-xl-11">
                                        <div class="row form-group">
                                            <%--  <div class="col-lg-3">
                                           <s:select list="selectConditionOther" name="objErrFilterList.deductee_name_condition" class="form-control" headerKey=""
                                        ...
                                        <div class="collapse" id="remainingFilter">
                                            <div class="row form-group">
                                                ...
                                                <div class="input-group col-lg-3">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-primary addon-btn" id="tdsDeductDateBtn" onmouseover="openCalendar('tdsDeductDate', 'tdsDeductDateCal');
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <s:select list="selectConditionOther" class="form-control" headerKey="" headerValue="--Select Certificate Number Type--" 
                                                          name="objErrFilterList.certificate_no_condition" title="Certificate Number Type"/></div>--%>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <s:hidden value="%{#session.get('SHOWERRORDETAILSRCHPG')}" id="recordsPerPage"/>                        
                        ...
                        <s:form name="deducteeErrorBugForm" id="deducteeErrorBugForm" method="POST" 
                                action="dynamicErrorDataManipulationAction?action=BulkUpdate" theme="simple">                            
            ...
            <div class="modal-dialog error-modal">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!--                        <div class="table-responsive mt-2" id="dataSpan1">
                                                    <table class="table table-bordered table-striped mb-1" id="table1">             
                                                        <thead>            
                                                            <tr>
                                                        ...
                                                        <tfoot>                    
                                                            <tr class="highlight header1" onclick="collapseOn(this);">         
                                                                <td class="text-center" title="Show Grand Total"> <img src="resources/images/global/sum-icon.png" class="cursor-pointer"> </td>                 
                                                                <td colspan="5" class="text-right"> Total</td>                       
                                                                <td class="text-right"> 
                                                                    <div class="data-height">1,10,000.00</div> 
                                                                </td>        
                                                                <td></td>                        
                                                                <td></td>                        
                                                                <td></td>                        
                        ...
                        <!--                        <div class="form-group">
                                                    <div class="row">
                                                        <div class="button-section col-md-12 my-1 text-center">
                                                            <button type="button" id="saveExitBtn" class="form-btn"><i class="fa fa-pencil-square" aria-hidden="true"></i>Update</button>
                                                        </div>
                                                    </div>
                                                </div>-->
                    </div>
