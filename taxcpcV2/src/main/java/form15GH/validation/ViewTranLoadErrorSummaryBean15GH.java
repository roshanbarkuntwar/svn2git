 ...
 * @author akash.dev
 */
public class ViewTranLoadErrorSummaryBean15GH {
    ...
    public String review_error_record;
    public String pending_for_review;

    public String getReview_error_record() {
        return review_error_record;
    }

    public void setReview_error_record(String review_error_record) {
        this.review_error_record = review_error_record;
    }

    public String getPending_for_review() {
        return pending_for_review;
    }

    public void setPending_for_review(String pending_for_review) {
        this.pending_for_review = pending_for_review;
    }
