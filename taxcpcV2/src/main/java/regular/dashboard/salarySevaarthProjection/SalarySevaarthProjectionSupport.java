 ...
 * @author kapil.gupta
 */
public class SalarySevaarthProjectionSupport {

    Util utl = new Util();

    public StringBuilder getBrowseGrid(List<SalarySevaarthProjectionBrowseEntity> entity, ViewClientMast clientmast, StringBuilder grid, int startindex, int pageNo) {
        try {
            grid.append("<div >");
...
//            
            ...
            if (entity != null && !entity.isEmpty()) {
                SalarySevaarthProjectionBrowseEntity sal_tran = null;
