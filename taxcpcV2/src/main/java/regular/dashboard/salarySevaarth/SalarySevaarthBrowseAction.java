 ...
 * @author kapil.gupta
 */
public class SalarySevaarthBrowseAction extends ActionSupport implements SessionAware {
    ...
    public String execute() throws Exception {
        ...
        try {
            ...
            setDataGridAction("salarySevaarthDataGrid");
            setBulkDownloadFor("");
            long total = 0l;
            ...
            if (total > 0) {
                ...
                if (!utl.isnull(getSearch()) && getSearch().equals("true")) {
                    recNumber = (String) session.get("SALSEVAARTHRECPERPG");
                } else {
            ...
            if (getSearch() != null && getSearch().equalsIgnoreCase("true")) {
                SalarySevaarthDB db = new SalarySevaarthDB();
                String l_query = db.getSalarySevaarthCountQuery(client, asmt, getSalSevaarthFilterData());
                utl.generateSpecialLog("Salary Sevaarth Query : ", l_query);
    ...
    public SalarySevaarthBrowseAction() {
        utl = new Util();
