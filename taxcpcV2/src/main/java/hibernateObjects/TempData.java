...
public class TempData implements java.io.Serializable {
    ...
    @Id
    @Column(name = "col1", length = 4000, nullable = true)
    private String col1;
    @Id
    @Column(name = "col2", length = 4000, nullable = true)
    private String col2;
    @Id
    @Column(name = "col3", length = 4000, nullable = true)
    private String col3;
    @Id
    @Column(name = "col4", length = 4000, nullable = true)
    private String col4;
    @Id
    @Column(name = "col5", length = 4000, nullable = true)
    private String col5;
    @Id
    @Column(name = "col6", length = 4000, nullable = true)
    private String col6;
    @Id
    @Column(name = "col7", length = 4000, nullable = true)
    private String col7;
    @Id
    @Column(name = "col8", length = 4000, nullable = true)
    private String col8;
    @Id
    @Column(name = "col9", length = 4000, nullable = true)
    private String col9;
    @Id
    @Column(name = "col10", length = 4000, nullable = true)
    private Long col10;
