 ...
 */
@Entity
@Table(name = "tds_misc_tran_load")
public class TdsMiscTranLoad implements java.io.Serializable {
    ...
    @Column(name = "total_g_b_amt")
    private Double total_g_b_amt;
    ...
    public Double getTotal_g_b_amt() {
        return total_g_b_amt;
    }

    public void setTotal_g_b_amt(Double total_g_b_amt) {
        this.total_g_b_amt = total_g_b_amt;
    }
