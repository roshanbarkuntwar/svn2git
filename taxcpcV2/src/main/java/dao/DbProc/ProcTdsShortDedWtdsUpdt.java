 ...
 * @author ayushi.jain
 */
public class ProcTdsShortDedWtdsUpdt {

    String proc_out_parameter;
    Util utl;

    public ProcTdsShortDedWtdsUpdt() {
        utl = new Util();
    }
            ...
            Work work = new Work() {
                ...
                public void execute(Connection cnctn) throws SQLException {
                    try {
                        ...
                        String executeProc = "{call lhs_tds.proc_tds_short_ded_wtds_updt(?,?,?,?,?,?,?,?,?)}";
                        ...
                        utl.generateSpecialLog("Procedure call proc_tds_short_ded_wtds_updt---  ", proc_out_parameter + "\n");
                        try {
                            clst.close();
