 ...
 * @author ayushi.jain
 */
public class ProcTranLoadErrorDwnld {

    String proc_out_parameter;
    Util utl;

    public ProcTranLoadErrorDwnld() {
        utl = new Util();
    }
        ...
        try {
            Work work = new Work() {
                ...
                public void execute(Connection cnctn) throws SQLException {
                    utl.generateLog("*****Proc_tran_load_error_dwnld parameters******", "");
                    ...
                    String proc = "{call lhs_tds_download.proc_tran_load_error_dwnld(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
