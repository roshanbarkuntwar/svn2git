 ...
 * @author ayushi.jain
 */
public class ProcTdsHigerRateUpdt {

    String proc_out_parameter;
    Util utl;

    public ProcTdsHigerRateUpdt() {
        utl = new Util();
    }
            ...
            Work work = new Work() {
                ...
                public void execute(Connection cnctn) throws SQLException {
                    try {
                        ...
                        String executeProc = "{call lhs_tds.proc_tds_higher_rate_updt(?,?,?,?,?,?,?,?,?)}";
                        ...
                        utl.generateSpecialLog("Procedure call proc_tds_higher_rate_updt---  ", proc_out_parameter + "\n");
                        try {
                            clst.close();
