 ...
 */
public class ProcDelTranSingleMulti {
  Util utl;
    String proc_out_parameter;
    
    public ProcDelTranSingleMulti() {
        utl = new Util();
    }
        ...
        try {
            Work work = new Work() {
                ...
                public void execute(Connection cnctn) throws SQLException {
                    ...
                    utl.generateLog(" a_in_json_query---", jsonobj);
                    ...
                    String proc = "{call LHS_TDS_IMP_TEMPLATE.proc_del_tran_single_multi(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
                    ...
                    cs.setString(12, jsonobj);
                    cs.setString(13, a_user_code);
                    cs.setNull(14, java.sql.Types.INTEGER);
                    
                    cs.registerOutParameter(15, Types.VARCHAR);//out parameter
                    cs.executeUpdate();
                    proc_out_parameter = cs.getString(15);
