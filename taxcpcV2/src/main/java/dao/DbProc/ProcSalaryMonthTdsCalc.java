 ...
 * @author kapil.gupta
 */
public class ProcSalaryMonthTdsCalc {

    Util utl;
    int proc_out_parameter;

    public ProcSalaryMonthTdsCalc() {
        utl = new Util();
    }
        ...
        try {
            Work work = new Work() {
                ...
                public void execute(Connection cnctn) throws SQLException {
                    utl.generateLog("*****Proc_salary_month_tds_calc******", "");
...
//                    utl.generateLog("a_month---" , a_month);
                    ...
                    String proc = "{call lhs_itp.proc_salary_month_tds_calc(?,?,?,?,?,?,?,?,?,?,?)}";
...
//                    cs.setString(8, a_month);
        ...
        utl.generateLog("Proc_salary_month_tds_calc proc_out_parameter is", proc_out_parameter);
