 ...
 * @author kapil.gupta
 */
public class ProcPanMastVerifiedBulk {

    Util utl;

    public ProcPanMastVerifiedBulk() {
        utl = new Util();
    }
        ...
        try {
            Work work = new Work() {
                ...
                public void execute(Connection cnctn) throws SQLException {
                    utl.generateLog("*****proc_pan_mast_verified_bulk parameters******", "");
                    ...
                    String proc = "{call lhs_tds.proc_pan_mast_verified_bulk(?,?,?,?,?,?,?,?,?,?,?)}";
