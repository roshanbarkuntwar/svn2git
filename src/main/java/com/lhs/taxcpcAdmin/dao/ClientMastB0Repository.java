...
@Repository
public interface ClientMastB0Repository extends JpaRepository<LhssysDefaultEntityClient, String>,GenericCustomRepository<String,LhssysDefaultEntityClient>{
