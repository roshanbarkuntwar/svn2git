...
function searchDatabaseTableFilter()
{
	...
	if (lhsIsNull(table_or_view_name) && lhsIsNull(object_type) ) {
        openErrorModal("Please select any filter to see the records !");
	}else{

	var actionUrl = "./getSearchDatabaseTableFilter?table_or_view_name=" +table_or_view_name+ "&object_type=" +object_type;
...
function searchDatabaseMainResponse(response) {
	 console.log(response);
	$('#databasemaintable').html('');
	$('#databasemaintable').html(response);
...
function searchDatabaseUserResponse(response) {
	 console.log(response);
	$('#databaseUsertable').html('');
	$('#databaseUsertable').html(response);
